...
public class GameJoystick {
	...
	public GameJoystick(Resources res){
		...
		_joystick = (Bitmap)BitmapFactory.decodeResource(res, org.libsdl.app.R.drawable.joystick);
		_joystickBg = (Bitmap)BitmapFactory.decodeResource(res, org.libsdl.app.R.drawable.joystick_bg);
