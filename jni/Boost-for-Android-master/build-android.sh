...
LIBRARIES=--with-libraries=date_time,filesystem,program_options,regex,signals,system,thread,iostreams,wave,chrono,atomic
...
case "$NDK_RN" in
	...
	5*)
		...
		;;
	8-crystax-1)
		TOOLCHAIN=${TOOLCHAIN:-arm-linux-androideabi-4.7}
		CXXPATH=$AndroidNDKRoot/toolchains/${TOOLCHAIN}/prebuilt/$PlatformOS-x86/bin/arm-linux-androideabi-g++
